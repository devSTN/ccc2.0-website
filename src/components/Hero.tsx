  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-x-hidden overflow-y-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 scanlines">
      ...
      <div className="absolute top-6 inset-x-0 z-30 flex justify-center px-4">
        <div className="flex gap-20 px-20 py-6 border-4 border-cyan-500 max-w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        {/* Dates */}
        <div className="inline-block mb-6 px-6 py-3 bg-cyan-900/20 border-4 border-cyan-500/40">
          <div className="flex flex-col">
            <span className="text-cyan-400 text-sm font-bold pixelated terminal-glow">
        ...
        {/* Title */}
        <h1
          className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 text-cyan-400 pixelated terminal-glow leading-tight"
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-cyan-300 mb-8 max-w-3xl mx-auto pixelated">
          {'>> JOIN THE ULTIMATE CYBERSECURITY HACKATHON'}
        </p>

        {/* Info Pills */}
        <div className="flex flex-wrap justify-center gap-8 mb-12 pixelated">
          <div className="flex items-center gap-2 text-cyan-300 border-2 border-cyan-500/50 px-4 py-2 bg-cyan-900/10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="px-8 py-4 bg-cyan-500 text-black font-bold pixelated border-4 border-cyan-400 hover:bg-cyan-400 transition-all duration-300 hover:scale-110 shadow-lg inline-block"
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="text-cyan-400 pixelated text-2xl terminal-glow">▼ ▼ ▼</div>
      </div>
    </section>
  );
}
